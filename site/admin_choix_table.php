...
<body>
	...
	<section>
		...
		<form action="admin_modif.php" method="post" enctype="multipart/form-data">
			<fieldset>
				<legend>Choisissez l'action à effectuer</legend>
					<input type="radio" name="type" value="Batiment" id ="Batiment" checked="checked" />
					<label for="Batiment"> Ajouter/supprimer un "Bâtiment" </label><br />
					<input type="radio" name="type" value="Capteur" id ="Capteur" />
					<label for="Capteur"> Ajouter/supprimer un "Capteur" </label><br />
					<input type="radio" name="type" value="Salle" id ="Salle" />
					<label for="Salle"> Ajouter/supprimer une "Salle" </label><br />
			</fieldset>
			<div>
